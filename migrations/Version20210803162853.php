 ...
 */
final class Version20210803162853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__registration AS SELECT id, start_zeit_id, start_punk_id, uuid, created, updated FROM registration');
        ...
        , created DATETIME DEFAULT NULL, updated DATETIME DEFAULT NULL, email VARCHAR(100) DEFAULT NULL, CONSTRAINT FK_62A8A7A794F7ACF4 FOREIGN KEY (start_zeit_id) REFERENCES start_zeit (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_62A8A7A7890B6AF8 FOREIGN KEY (start_punk_id) REFERENCES start_punkt (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO registration (id, start_zeit_id, start_punk_id, uuid, created, updated) SELECT id, start_zeit_id, start_punk_id, uuid, created, updated FROM __temp__registration');
